...
var db = /** @class */ (function () {
    ...
    db.prototype.registerUser = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var query, conn, res, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "INSERT INTO users (username,pass) values ('" + params['username'] + "','" + params['pass'] + "')";
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        if (typeof res['insertId'] === 'undefined') {
                            return [2 /*return*/, 'Insert failed!'];
                        }
                        return [2 /*return*/, 'Success!']; //test this on postman
                    case 4:
                        err_1 = _a.sent();
                        throw err_1;
                    case 5:
